Here's the updated README with a new step added before "12. Connect ESP32 to Wi-Fi and Configure Feeder":

---

# Pet Feeder

This project enables you to build an automated pet feeder using an ESP32 microcontroller. The feeder can be controlled via Telegram and includes features such as battery level monitoring, load cell calibration, and sending updates to a Telegram group.
...
### 4. (Optional) Calibrate Battery Percentage
For better accuracy in battery percentage readings, customize the `VoltageSensor::getBatteryPercentage` method based on your 18650 battery's voltage-to-percentage graph.

### 5. (Optional) Adjust Voltage Sensor Multipliers
...
### 11. Create a Telegram Group and Retrieve Group ID
...
### 13. Connect ESP32 to Wi-Fi and Configure Feeder
